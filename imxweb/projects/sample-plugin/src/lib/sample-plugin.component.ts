...
import { PortalPersonMasterdata, PortalPersonMasterdataInteractive, PortalPersonReportsInteractive, ProjectConfig } from 'imx-api-qer';
...
export class SamplePluginComponent implements OnInit {
  ...
  actionText: string = "";
  description: string = "View presonal information of the logged in user"
