// Full Leaflet 1.9.4 CSS embedded as a string and injected at runtime via <style> tag.
// This bypasses any Angular CSS bundling / host platform overrides that may strip or
// reorder external stylesheets in production.
...
/**
 * Injects the Leaflet CSS into the document head exactly once.
...
export function ensureLeafletStyles(): void {
  ...
  styleEl.setAttribute('data-geo-plugin', 'leaflet-css');
